<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddFaculty.aspx.cs" Inherits="SMS.AddFaculty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table class="auto-style1">
            <tr>
                <td colspan="2" style="text-align: center; font-size: large; font-weight: bolder; font-style: normal;" class="auto-style4">Faculty Registeration</td>
            ...
            <tr>
                <td class="auto-style2" style="text-align: center; vertical-align: top;">Years Of Experience</td>
                <td style="text-align: center" class="auto-style6">
                    <asp:TextBox ID="TextBox12" runat="server" TextMode="Number"></asp:TextBox>
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="TextBox12" ErrorMessage="Experience is Required" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>

            </tr>

            <tr>
                <td class="auto-style2" style="text-align: center; vertical-align: top;">Expertise In</td>
                <td style="text-align: center" class="auto-style6">
                    <asp:TextBox ID="TextBox13" runat="server"></asp:TextBox>
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="TextBox13" ErrorMessage="Expertisation is Required" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
